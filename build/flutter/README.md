...
* `web_portfolio` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `Web Portfolio` - executable or bundle name on disk.
* `Web Portfolio` - display name shown in window titles and about app dialogs.
